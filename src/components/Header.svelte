...
>
  <h1 class="font-medium">
    <b class="font-bold poppins">Will</b> <span class="">Jarrard</span>
  </h1>
  ...
  <a
    ...
    class="greenShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950 inline-block"
  >
    <div
